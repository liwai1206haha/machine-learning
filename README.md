...
感知机是解决分类问题
    1. 与问题，或问题， 亦或问题
    2. 单个感知机解决不了的问题，可以增加感知机 
    
9. 神经网络： 多分类
    1. 神经网络的API模块
    ![img.png](img/神经网络的API模块.png)
       
    2. Softmax回归： 神经网络输出层的输出经过softmax，将输出转换为相应类别的概率
       ![img.png](img/softmax回归.png)
    3. 损失计算
        交叉熵损失： 一个样本就一头一个交叉熵损失，其中真实结果使用one-hot编码。最终求所有样本的损失，然后求平均损失
       ![img.png](img/算法的比较.png)
       ![img.png](img/正向传播和反向传播.png)
       
    4. 简单的神经网络实现手写数字识别的API
        1. 全连接 - 从输入直接到输出![img.png](img/特征加权.png)
